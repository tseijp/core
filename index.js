...
function Trees(props) {
  ...
  return /*#__PURE__*/React.createElement(TreesTop, {
    style: style,
    size: size
  }, !content ? null : /*#__PURE__*/React.createElement(TreesIcon, _extends({
    color: color,
    size: size,
    viewBox: viewBox
...
var Wrap$1 = styled(animated.div)(_templateObject$5());
...
function Slide(_ref) {
  ...
  var prev = useRef([0, 1]);
  var wheelOffset = useRef(0);
  var dragOffset = useRef(0);
  var runSprings = useCallback(function (xy, vxy) {
  ...
  return /*#__PURE__*/React.createElement(Wrap$1, bind(), springs.map(function (_ref4, i) {
    var x = _ref4.x;
...
var SplitWrapp = styled(animated.div)(_templateObject$6());
