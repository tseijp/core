...
var Card = function Card(_ref) {
  ...
  var calc = useCallback(function (x, y) {
...
var TreesContent = function TreesContent(_ref) {
  ...
  return !content ? null : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Icon, {
    style: _extends_1({}, styles$6.tggl, {
      opacity: opacity,
      color: color
    }),
    onClick: iconClick
  }), /*#__PURE__*/React.createElement("span", {
    style: _extends_1({}, styles$6.type, {
      marginRight: type ? 10 : 0,
      color: color
    })
  }, type), hide && /*#__PURE__*/React.createElement(TreeIcon.EyeO, {
    style: _extends_1({}, styles$6.tggl, {
      color: color
    }),
    onClick: eyeClick
  }), /*#__PURE__*/React.createElement("span", {
    style: _extends_1({}, styles$6.cont, {
      color: color
    })
  }, content));
};
var Trees = function Trees(_ref2) {
  var _ref2$open = _ref2.open,
      ...
      props = objectWithoutPropertiesLoose(_ref2, ["open", "visible", "immediate", "depth", "root", "springConfig", "dark", "size", "style", "topStyle"]);
  ...
  var spring = useSpring({
    ...
    config: _extends_1({}, config.default, springConfig),
    from: {
      height: 0,
      opacity: 0,
  ...
  var children = useMemo(function () {
    return Children.map(props.children, function (child) {
      ...
      var grand = Children.toArray((_ref3 = child) == null ? void 0 : (_ref3$props = _ref3.props) == null ? void 0 : _ref3$props.children) || [];
  ...
  return /*#__PURE__*/React.createElement(animated.div, {
    style: _extends_1({}, styles$6.tree, {
      fontSize: size * 50,
      zIndex: -depth
    }, style, topStyle)
...
export { Card, Code, Foot, Grow, Head, Icon, Modal, Notes, NotesItem, NotesSide, Pills, Sides, SidesArea, SidesContainer, SidesIcon, SidesItem, Split, Trans, TransArea, TransContainer, TransIcon, TransItem, TreeIcon, Trees, TreesContent, clamp, getWRate, is, merge, range, samp, sign, swap, topUp };
